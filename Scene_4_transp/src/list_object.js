...
{
    tab[c] = sphere(core, [50, 50, 50, 8, 0, 1], [0, 0, 0, c, 200], [0, 0, 0, null]);
    tab[++c] = plan(core, [150, 50, 255, 100, 0, 1], [0, -100, 0, c, 50], [90, 0, 0, null]);
    tab[++c] = cylindre(core, [100, 255, 50, 5, 0, 1], [0, 0, -400, c, 100], [90, 0, 0, null, null]);
    tab[++c] = cone(core, [255, 150, 50, 1, 0, 1], [0, 300, 400, c, 10], [90, 0, 0, 0, -500]);
    tab[++c] = sphere(core, [255, 0, 0, 100, 0, 1], [500, 100, 0, c, 100], [0, 0, 0, null]);
